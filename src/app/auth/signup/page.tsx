    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-4">
        <div className="text-center max-w-sm">
          ...
          <h2 className="text-xl font-bold text-[#3e260f]">Check your email</h2>
          <p className="text-[rgba(62,38,15,0.5)] mt-2 text-sm">
    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-[rgba(62,38,15,0.5)] text-sm">Start building your recipe collection</p>
        </div>
        ...
        <p className="text-center text-sm text-[rgba(62,38,15,0.5)] mt-6">
          ...
          <Link href="/auth/login" className="text-[#b9732c] hover:text-[#a0621f] font-semibold">
            Sign in
          </Link>
        </p>
      </div>
